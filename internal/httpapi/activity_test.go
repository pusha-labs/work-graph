...
func TestDescribeActivity(t *testing.T) {
	tests := []struct {
		...
		{"module version changed", "workflow_step.updated", `{"name":"Call API","previousName":"Call API","previousModuleVersion":"0.1.0","moduleVersion":"0.2.0"}`, "Module version: 0.1.0 → 0.2.0"},
